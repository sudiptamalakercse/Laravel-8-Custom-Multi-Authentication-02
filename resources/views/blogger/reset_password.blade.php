...
<html>
  ...
  <title>Reset Your Password As Blogger</title>
...
<div class="container">
  ...
  <div class="row">        
    <div class="col-md-4 offset-md-4">
         <h3 class="mb-3 text-center">Reset Your Password As Blogger</h3>
@if ($errors->any())
...
@endif
      <form action="{{route('blogger-password-update')}}" method="post">
          @csrf
  <div class="mb-3">
